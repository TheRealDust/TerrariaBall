...
{
    public class KiFragLevel4 : ModItem
    {
        public static int DropRate = 3;
        public static int DropsFrom = NPCID.Golem;
        ...
        public override bool CanUseItem(Player player)
        {
            ...
            return player.whoAmI == Main.myPlayer && !modPlayer.KiFragLevel4;
        }

        public override bool UseItem(Player player)
        {
            TerrariaBallPlayer modPlayer = player.GetModPlayer<TerrariaBallPlayer>();
            modPlayer.KiFragLevel4 = true;
